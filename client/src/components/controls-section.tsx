...
function autoAssignChannel(
  ...
  // Threshold at 0.60: only clearly vivid colors qualify for auto-assign.
  // Greys, muted tones, and lightly-tinted neutrals all sit below this.
  if (s < 0.60 || l < 0.08 || l > 0.93) return null;
